...
const Details = () => {
  ...
  return (
    <div className="my-10 bg-slate-200 p-10">
      ...
      <div>
        <h1 className="text-2xl lg:text-3xl text-[#23BE0A] font-semibold my-2">{estate_title}</h1>
        ...
        <div className="mt-9 bg-white p-7">
          ...
          <div className="flex ml-10 lg:ml-1 flex-col lg:flex-row justify-around">
          ...
          <h1 className="text-xl lg:text-2xl font-semibold mt-4">Features:</h1>
          <div className="flex flex-col lg:flex-row gap-2 lg:gap-16 ml-16 text-lg">
