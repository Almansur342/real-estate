...
const UpdateProfile = () => {
  ...
  return (
    <div className="bg-slate-200 my-10 p-10">
      <div className="max-w-lg rounded-xl mx-auto p-8 sm:flex sm:space-x-6 bg-white text-black border-2">
        <div className="flex-shrink-0 w-full mb-6 h-44 sm:h-32 sm:w-32 sm:mb-0">
          <img src={user?.photoURL || 'https://i.ibb.co/7z4LN8c/pexels-pixabay-34534.jpg'} alt="" className="object-cover object-center w-full h-full rounded bg-gray-500" />
        </div>
